...
/* send pictures over Xbee Series 2 RF modules with arduino (done in 2017) */
...
void setup() {
  ...
  Wire.begin();
  Serial.begin(115200);
  Xbee.begin(115200); // Set up both ports at this baud. 
#endif
...
void loop() {
  ...
  if (myCAM.get_bit(ARDUCHIP_TRIG, CAP_DONE_MASK))
  {
    ...
    //the head of the image data is 0xFF 9xD8
